...
function Demo() {
  return (
   ...
   <button type="button" className="btnn"> Work with us </button> 
    </div> 
    </div>
   <br></br>
...
<div>
    <div className="section">
        ...
        <p> Ut enim ad minim veniam, quis nostrud exercitation ullamco 
            ...
            dolore eu fugiatnulla pariatur.</p>
            </div> 
...
<div>
   ...
   {/* <p> What is Naturopath? </p>  */}
    <disable>  <input type="Name" placeholder="What is Naturopath? ^"></input></disable>
